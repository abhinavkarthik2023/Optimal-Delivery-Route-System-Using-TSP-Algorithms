...
def tsp_brute_force(locations, distance_matrix):
    ...
    print("Brute force TSP completed. Best route: {best_route} with distance: {min_distance}")
...
def tsp_genetic_algorithm(locations, distance_matrix, population_size=50, generations=500):
    ...
    print(f"Initial population generated.")
    ...
    for generation in range(generations):
        ...
        print(f"Generation {generation+1}: Best distance {1/population_sorted_by_fitness[0][1]}")
    ...
    print("Genetic algorithm TSP completed. Best route found.")
...
def simulated_annealing(locations, distance_matrix):
    ...
    print("Starting simulated annealing TSP...")
    ...
    while temp > 1:
        ...
        if new_distance < min_distance or random.random() < exp((min_distance - new_distance) / temp):
            ...
            if new_distance < min_distance:
                ...
                min_route = current_route
        temp *= (1 - cooling_rate)
        print(f"Temperature: {temp:.2f}, Current best distance: {min_distance}")

    print("Simulated annealing TSP completed.")
...
def branch_and_bound(locations, distance_matrix):
    ...
    for route in itertools.permutations(locations):
        ...
        if current_distance < best_distance:
            ...
            best_route = route
            print(f"New best route found with distance: {current_distance}")

    print("Branch and bound TSP completed.")
    return best_route, best_distance
